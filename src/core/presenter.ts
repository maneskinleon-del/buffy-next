...
import type { DoctorReport, DiagnosticItem, Capability, ActionResult, PlatformInfo, SystemInfo, CheckResult, RecommendedAction, Observation, Inference } from './types.js';
